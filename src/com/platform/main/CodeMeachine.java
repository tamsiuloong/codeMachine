...
public class CodeMeachine {
	...
	private static String packageName = "com.yaorange.com";
	public static String rootPath = "system";
	public static String entityRemark = "部门";
//	public static
	...
	public static void generateFileWithDb(String templateName,String tableName,String packageName,String classPre,String fileName) throws SQLException{
		Map<String, Object> templateData = dataService.getDbTemplateData(tableName, packageName, classPre, null);
		freeMakerUtil.generateFile(templateName, templateData, generatePath+fileName);
	}
	
	public static void generateFileWithDb(String templateName, String tableName, String fileNameSuffix, List<String> exclusiveFiled) throws SQLException{
		String className = ConvertUtil.getClassName(tableName);
		Map<String, Object> templateData = dataService.getDbTemplateData(tableName, packageName, className,exclusiveFiled);
	...
	public static void setRootPath(String rootPath) {
		CodeMeachine.rootPath = rootPath;
	}

	public static void setEntityRemark(String entityRemark) {
		CodeMeachine.entityRemark = entityRemark;
	}
}
